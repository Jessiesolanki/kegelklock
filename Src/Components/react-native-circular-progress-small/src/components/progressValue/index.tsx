...
const ProgressValue: React.FC<ProgressValueProps> = ({
  ...
  // console.log(animatedTextProps,'animatedTextPropsanimatedTextProps')
  // console.log(inputRef.current.value,'ddf')
  console.log(animatedTextProps.initial.value.text,'animatedTextPropsanimatedTextProps')
  return (
    <AnimatedInput
